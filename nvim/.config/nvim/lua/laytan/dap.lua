...
vim.keymap.set('n', '<leader>bo', function() require('dapui').toggle() end)
vim.keymap.set('n', '<leader>bc', ':DapContinue<cr>')
vim.keymap.set('n', '<leader>bb', ':DapToggleBreakpoint<cr>')
vim.keymap.set('n', '<leader>bB', function() require('dap').toggle_breakpoint(vim.fn.input('[DAP] Condition > ')) end)
